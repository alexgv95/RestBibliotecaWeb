        ...
        try {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<tr><th>Título</th>"
                        + "<th>Autor</th>" + "<th>Nº Páginas</th><th>hObtener Libro</th></tr>");
                for (int i = 0; i < listaLibros.getLibros().size(); i++) {
                    ...
                    out.println("<td><form action='elegirLibro.html'>");
                    out.println("<input type='hidden' value='"+listaLibros.getLibros().get(i)+"'>");
                    
                    out.println("<input type='submit' value='Obtener libro'>");
                    out.println("</form></td>");
